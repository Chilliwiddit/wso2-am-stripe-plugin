...
public class StripeSubscriptionCreationWorkflowApprovalExecutor extends WorkflowExecutor {

    private static final Log log = LogFactory.getLog(StripeSubscriptionCreationWorkflowApprovalExecutor.class);
    ...
    /**
     * This method executes subscription creation approval workflow and return workflow response back to the caller
     *
    ...
    public WorkflowResponse execute(WorkflowDTO workflowDTO) throws WorkflowException {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Executing Stripe Subscription Creation Webservice Workflow.. ");
        }
    ...
    /**
     * Complete the Approval workflow executor for Stripe Subscription creation.
     *
     * @param workflowDTO
     */
    @Override
    ...
    /**
     * Handle cleanup task for Stripe subscription creation Approval workflow executor.
    ...
    public void cleanUpPendingTask(String workflowExtRef) throws WorkflowException {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Starting cleanup task for StripeSubscriptionCreationWorkflowApprovalExecutor for :" + workflowExtRef);
        }
        try {
            ApiMgtDAO apiMgtDAO = ApiMgtDAO.getInstance();
